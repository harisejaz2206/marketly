...
const perks = [
  ...
  },
  {
    name: "For the planet",
    Icon: Leaf,
    description: "We've pledged 1% of sales to the preservation and restoration of the natural planet",
  }
]
    ...
    <>
      <MaxWidthWrapper>
        <div className=" py-20 mx-auto text-center flex flex-col items-center max-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">Welcome to Marketly. Every asset on our platform is verifed by our team to ensure our highest quality standards</p>
