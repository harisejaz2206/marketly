    ...
    return (
        <Sheet>
            <SheetTrigger className="group -m-2 flex items-center p-2">
                <ShoppingCart
                    className="h-6 2-6 flex-shrink-0 text-gray-400 group-hover:text-gray-500" aria-hidden='true'>
                </ShoppingCart>
            ...
            <SheetContent className="flex w-full flex-col pr-0 sm:max-w-lg">
                ...
                {itemCount > 0 ? (
                    ...
                    <div className="flex h-full flex-col items-center justify-center space-y-1">
                        ...
                        <SheetTrigger>
                            <Link href='/products' className={buttonVariants({ variant: "link", size: "sm", className: "text-sm text-muted-foreground text-blue-500" })}>Add items to your cart to checkout</Link>
                        </SheetTrigger>
                    </div>
                )}
            </SheetContent>
